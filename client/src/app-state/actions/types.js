...
export const GET_POSTS_ADDED_SINCE_LAST_FETCH =
...
export const CREATE_CONV_ERROR = "CREATE_CONV_ERROR";
...
export const SOCKET_SENT_MSG = "SOCKET_SENT_MSG";
export const SOCKET_RECEIVED_MSG = "SOCKET_RECEIVED_MSG";
